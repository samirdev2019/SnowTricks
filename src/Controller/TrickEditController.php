...
class TrickEditController extends AbstractController 
{
     ...
     *@Route("/member/snowtrick/edit-illustration/{id}", name="edit_illustration", methods="GET|POST")
     */
    public function editIllustration(Illustration $illustration, Request $request):Response
    {
        if(!$illustration) {
            //exception page 404 
        }
        ...
        if($form->isSubmitted() && $form->isValid()) {
            ...
            if( $file ) {
                ...
                $trick = $this->trickRepository->findOneBy(['id'=>$illustration->getTrick()->getId()]);
        ...
        return $this->render('tricks/edit-illustration.html.twig',['form' => $form->createView()]);  
    }
    /**
     * This method allow to edit a illustration
     *@Route("/member/trick/{id}/add-illustration/", name="add_illustration", methods="GET|POST")
     */
    ...
    /**
     * This method allow to delete a illustration 
     *
    ...
    {
        //dump($illustration);die();
        $this->manager->remove($illustration);
        $this->manager->flush();
        return $this->redirectToRoute('edit_trick',['id'=>$illustration->getTrick()->getId()]);
    ...
    public function editVideo(Video $video, Request $request):Response
    {
        ...
        if($form->isSubmitted() && $form->isValid()) {
            ...
            $trick = $this->trickRepository->findOneBy(['id'=>$video->getTrick()->getId()]);
        ...
        return $this->render('tricks/edit-video.html.twig',['formVideo'=>$form->createView()]);
    }
    /**
     * Undocumented function
     *
    ...
    /**
     * This method allow to delete a video 
     *
    ...
    public function deleteVideo(Video $video)
    {
        ...
        $this->manager->flush();
        return $this->redirectToRoute('edit_trick',['id'=>$video->getTrick()->getId()]);
    ...
    public function deleteComment(Comment $comment)
    {
        ...
        $this->manager->flush();
        return $this->redirectToRoute('edit_trick',['id'=>$comment->getTrick()->getId()]);
    }
}
